...
MISSION_fnc_createConvoy = {
    ...
    for "_i" from 0 to (_vehicleCount - 1) do {
        ...
        // Add fuel and set invulnerable until player engages
        _vehicle setFuel 1;
        ...
        private _driver = _group createUnit ["O_Soldier_F", _vehiclePos, [], 0, "FORM"];
        _driver moveInDriver _vehicle;
        _driver setSkill (MISSION_CONFIG get "aiSkill");

        private _gunner = _group createUnit ["O_Soldier_F", _vehiclePos, [], 0, "FORM"];
        ...
        for "_j" from 1 to _cargoCount do {
            private _cargo = _group createUnit ["O_Soldier_F", _vehiclePos, [], 0, "FORM"];
