...
// ===================================================================
// EXILE SERVER INITIALIZATION - FIXED PATHS
// ===================================================================
...
// 1. Ravage (event handler must be first)
[] execVM "scripts\rmg_ravage_exile_config.sqf";
diag_log "[SERVER] - Ravage config loaded";
sleep 1;

// 2. Elite Driving (v9.7 Apex Edition - A3XAI Safe)
[] execVM "scripts\ead_v95_apex.sqf";
diag_log "[SERVER] - Elite Driving v9.7 Apex Edition loaded (A3XAI Safe)";
sleep 1;

// 3. Patrol system
[] execVM "scripts\fn_aiPatrolSystem.sqf";
diag_log "[SERVER] - Patrol system loaded";
sleep 1;
