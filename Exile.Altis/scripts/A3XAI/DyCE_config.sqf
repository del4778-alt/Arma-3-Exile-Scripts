...
DyCE_Config = createHashMapFromArray [
    ...
    // ========================================
    // CONVOY LIMITS (v3.26: Reduced to keep total AI ~80)
    // ========================================
    ["maxArmedConvoys", 2],             // Max armed ground convoys (~6 AI each = 12)
    ["maxTroopConvoys", 1],             // Max troop transports (~8 AI each = 8)
    ["maxHighwayPatrols", 3],           // Max highway patrols (~3 AI each = 9)
    ["maxSupplyTrucks", 1],             // Max supply truck convoys (~3 AI each = 3)
    ["maxTotalDynamicEvents", 6],       // Max combined dynamic events (~32 AI total)
