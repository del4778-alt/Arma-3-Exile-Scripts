...
if (isNull _group) exitWith {
    [1, format ["Camp '%1' FAILED: createGroup returned null - EAST limit reached", _missionName]] call A3XAI_fnc_log;
    createHashMap
};
...
if (_groupSide != EAST) exitWith {
    ...
    deleteGroup _group;
    [1, format ["Camp '%1' FAILED: Group created as %2 instead of EAST (EAST: %3/144)", _missionName, _groupSide, _eastGroups]] call A3XAI_fnc_log;
    createHashMap
};
