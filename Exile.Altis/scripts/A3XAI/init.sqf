...
// ✅ v3.26: CORRECT FACTION SETUP
// EAST = A3XAI + DyCE (ENEMY AI)
// WEST = Zombies (ENEMY to all)
// RESISTANCE = Players + fn_aiPatrol (FRIENDLY patrols)
// INDEPENDENT = Recruit AI (FRIENDLY companions)
// CIVILIAN = Exile players default side

// --- EAST (A3XAI/DyCE) is HOSTILE to everyone except itself ---
EAST setFriend [WEST, 0];           // A3XAI vs Zombies = HOSTILE
EAST setFriend [RESISTANCE, 0];     // A3XAI vs Players/Patrols = HOSTILE
EAST setFriend [INDEPENDENT, 0];    // A3XAI vs Recruit AI = HOSTILE
EAST setFriend [CIVILIAN, 0];       // A3XAI vs Civilians = HOSTILE

// --- WEST (Zombies) is HOSTILE to everyone ---
WEST setFriend [EAST, 0];           // Zombies vs A3XAI = HOSTILE
WEST setFriend [RESISTANCE, 0];     // Zombies vs Players = HOSTILE
WEST setFriend [INDEPENDENT, 0];    // Zombies vs Recruit AI = HOSTILE
WEST setFriend [CIVILIAN, 0];       // Zombies vs Civilians = HOSTILE

// --- RESISTANCE (Players + Patrols) ---
RESISTANCE setFriend [EAST, 0];     // Players vs A3XAI = HOSTILE
RESISTANCE setFriend [WEST, 0];     // Players vs Zombies = HOSTILE
RESISTANCE setFriend [INDEPENDENT, 1]; // Players FRIENDLY to Recruit AI
RESISTANCE setFriend [CIVILIAN, 1];    // Players FRIENDLY to Civilians

// --- INDEPENDENT (Recruit AI) ---
INDEPENDENT setFriend [EAST, 0];    // Recruits vs A3XAI = HOSTILE
INDEPENDENT setFriend [WEST, 0];    // Recruits vs Zombies = HOSTILE
INDEPENDENT setFriend [RESISTANCE, 1]; // Recruits FRIENDLY to Players/Patrols
INDEPENDENT setFriend [CIVILIAN, 1];   // Recruits FRIENDLY to Civilians

// --- CIVILIAN (Exile default player side) ---
CIVILIAN setFriend [EAST, 0];       // Civilians vs A3XAI = HOSTILE
CIVILIAN setFriend [WEST, 0];       // Civilians vs Zombies = HOSTILE
CIVILIAN setFriend [RESISTANCE, 1]; // Civilians FRIENDLY to Players
CIVILIAN setFriend [INDEPENDENT, 1];// Civilians FRIENDLY to Recruits

diag_log "[A3XAI] ✅ v3.26 Faction relations:";
diag_log "[A3XAI]    EAST (A3XAI) = ENEMY to all";
diag_log "[A3XAI]    WEST (Zombies) = ENEMY to all";
diag_log "[A3XAI]    RESISTANCE (Players/Patrols) + INDEPENDENT (Recruits) + CIVILIAN = FRIENDLY to each other";
